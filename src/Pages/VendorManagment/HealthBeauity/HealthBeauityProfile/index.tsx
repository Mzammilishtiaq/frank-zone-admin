...
import HandyDetail from './HealthBeauityDetail';
import DocumentVerfication from './HealthBeauityDocumentVerfication';
import HandyProduct from './HealthBeauityProduct';
import HandyQuestion from './HealthBeauityQuestion';
import HandyRatingReview from './HealthBeauityReviewRating';
import { profileTypes } from '@src/Shared/enum/enum';

function HealthBeauityProfile() {
    ...
    <div>
      ...
      <div role="presentation" className='mb-3'>
          ...
          <div className="flex items-center justify-between">
            <h5 className='text-xl sm:text-lg font-medium text-[rgba(5, 25, 23, 1)]'>Health & Beauty Vendor Managment</h5>
          </div>
        </div>
...
export default HealthBeauityProfile;