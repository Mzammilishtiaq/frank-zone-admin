...
import Bannerimg from '@src/assets/image/healthbeauty-banner.png';


function HealthBeauityDetail() {
  return (
    <>
      <div className="profiledetail">
        ...
        <div className=" flex flex-col gap-2 py-5">
          <h5 className='font-semibold text-2xl sm:text-lg text-black-900'>Shop Details</h5>
          <img src={Bannerimg} className='w-full my-2' alt="" />
          <div className="flex sm:flex-col md:flex-col items-center justify-start sm:gap-3 md:gap-3 gap-5">
            <div className='flex flex-col gap-3 md:gap-1 pr-14 border-r-2 pl-2 border-gray-400 
            sm:pl-0 sm:pr-0 sm:border-r-0 sm:w-full
            md:pl-0 md:pr-0 md:border-r-0 md:w-full
            '>
            ...
            <div className='flex flex-col gap-3 md:gap-1 px-14 
            sm:items-start sm:justify-start sm:pr-10 sm:px-0 sm:w-full
            md:items-start md:justify-start md:pr-10 md:px-0 md:w-full
            '>
            ...
            [1, 1, 1, 1, 1, 1].map((item) => (
              <CustomCard styleClass={'p-4 !flex-row sm:!flex-col md:!flex-col items-center  my-3'}>
                <div className='flex flex-col items-center w-full'>
                  ...
                  <img src={Profileimg} className='w-40 sm:w-20 md:w-20' alt="" />
                </div>
...
export default HealthBeauityDetail;
