        ...
        },
        {
            ...
            render: (name: string, row: any) => (
                <div className="w-full flex items-center justify-end gap-3">
                    ...
                    />
                    <CustomButton icon={<img src={viewbtn} className='w-4' />} handleButtonClick={() => navigate(`/vendor_managment/health_beauty/health_beauty_profile/${row.phone}`)} type={'button'} />
                </div>
            )
        }
    ]
       ...
       <>
         ...
         <div role="presentation" className='mb-3'>
                ...
                <div className="flex items-center justify-between">
                    <h5 className='text-2xl sm:text-lg font-medium text-[rgba(5, 25, 23, 1)]'>Health & Beauty Vendor Managment</h5>
                </div>
            </div>
...
export default HealthBeauityList