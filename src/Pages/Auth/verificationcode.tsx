                    ...
                    >
                        <Form className='w-full flex flex-col items-center text-left justify-center gap-5 mx-16'>
                            <OTPInput
                                ...
                                numInputs={6}
                                shouldAutoFocus
                                inputStyle={`focus:outline-blue-900 bg-white border-2 flex  border-black-500 text-2xl font-normal text-black-900 rounded-lg py-3 sm:!w-9 !w-10 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                            ...
                            <div className="sm:w-full w-full flex flex-row items-center justify-center gap-2">
                                <span className='sm:text-[12px]'>Didn't received the email?</span>
                                <Link className='sm:text-[12px] text-blue-600 ' to={'/forgotpassword'}>Resend email</Link>
                            </div>
                        </Form>
                    </Formik>
                </CustomCard>
